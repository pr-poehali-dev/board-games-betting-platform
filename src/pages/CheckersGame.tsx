          ...
          <Card className="max-w-md mx-auto p-6">
            <div className="flex flex-col items-center space-y-6">
              ...
              <p className="text-center text-muted-foreground">
                Поиск соперника с рейтингом 1700-1800...
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge variant="outline" className="text-md bg-secondary/10 font-medium">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Рейтинг: 1750</div>
                      </div>
                    </div>
                  ...
                  <Card>
                    <CardContent className="p-4 space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-sm">CHK-{Math.floor(10000 + Math.random() * 90000)}</span>
                      </div>
                    </CardContent>
                  </Card>
                </div>
